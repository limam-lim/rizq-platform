# دليل لوحات التحكم والمستخدم — رزق

**الإصدار:** 1.2 · **سبتمبر 2026** · ADMINIA SARL

> **النسخة المرئية بالصور:** افتح [`rizq_help.html`](../../rizq_help.html)  
> **الكتيب الشامل:** [`RIZQ_PLATFORM_MANUAL.md`](../../RIZQ_PLATFORM_MANUAL.md)

هذا الملف يشرح للمستخدم والأدمن: التسجيل، الموافقة، الدخول، أنواع اللوحات، الفيديو التعريفي، ونشر الإعلان.
...
| الدليل | المسار / الرابط |
|--------|------------------|
| الدليل المرئي (صور) | `rizq_help.html` |
| دليل اللوحات (هذا الملف) | `GET /api/help-guide/dashboard-guide` أو `rizq-backend/help/dashboard-guide.md` |
| الكتيب الشامل | `GET /api/help-guide/platform-manual` أو `RIZQ_PLATFORM_MANUAL.md` |

الصور التوضيحية: مجلد `/help-images/` (`fig1-journey.svg` … `fig4-dashboard-types.svg`).
