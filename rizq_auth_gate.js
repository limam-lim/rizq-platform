...
(function () {
  ...
  function injectStyle() {
    ...
    var css = [
      ...
      '@media (max-width:768px){#rag-overlay .rag-title{font-size:1.55rem!important}#rag-overlay .rag-choice-card{padding:18px 16px;min-height:80px;border-width:2px;box-shadow:0 8px 22px rgba(15,35,65,.08)}#rag-overlay .rag-choice-title{font-size:16.5px}#rag-overlay .rag-choice-sub{font-size:13px;color:#475569}#rag-overlay .rag-choice-icon{width:52px;height:52px;font-size:24px}#rag-overlay .rag-legal{margin-top:20px;padding:16px 14px calc(16px + env(safe-area-inset-bottom,0px))!important;border-radius:14px 14px 0 0}#rag-overlay .rag-legal-links{flex-direction:column;align-items:stretch}#rag-overlay .rag-legal-links a{width:100%;justify-content:center;min-height:44px}#rag-overlay .rag-topbar{padding:14px 16px;gap:12px}#rag-overlay .rag-back{min-height:48px;font-size:15px;padding:12px 18px}#rag-overlay .rag-close{width:48px;height:48px;font-size:22px}}',
      ...
      '#rag-overlay .rag-legal-phones{display:flex;flex-direction:column;gap:6px;font-size:12.5px;line-height:1.5;text-align:center}',
      '#rag-overlay .rag-legal-phones a{color:rgba(255,255,255,.85)!important;background:transparent!important;border:none!important;padding:2px 0!important;font-weight:700!important;font-size:12.5px!important}',
