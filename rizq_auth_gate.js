...
(function () {
  ...
  function injectStyle() {
    ...
    var css = [
      ...
      '@media (max-width:768px){#rag-overlay .rag-title{font-size:1.55rem!important}#rag-overlay .rag-choice-card{padding:18px 16px;min-height:80px;border-width:2px;box-shadow:0 8px 22px rgba(15,35,65,.08)}#rag-overlay .rag-choice-title{font-size:16.5px}#rag-overlay .rag-choice-sub{font-size:13px;color:#475569}#rag-overlay .rag-choice-icon{width:52px;height:52px;font-size:24px}#rag-overlay .rag-legal{flex-direction:column;align-items:stretch;gap:10px;padding:16px 14px 28px!important;margin-top:20px;padding-bottom:calc(28px + env(safe-area-inset-bottom,0px))!important}#rag-overlay .rag-legal a{width:100%;justify-content:center;min-height:48px;font-size:14px!important;border-radius:12px!important;border-width:2px!important;background:#fff!important;color:#0f2347!important;box-shadow:0 4px 12px rgba(15,35,65,.06)}#rag-overlay .rag-topbar{padding:14px 16px;gap:12px}#rag-overlay .rag-back{min-height:48px;font-size:15px;padding:12px 18px}#rag-overlay .rag-close{width:48px;height:48px;font-size:22px}}',
      ...
      '#rag-overlay .rag-legal{display:flex!important;flex-wrap:wrap;align-items:center;justify-content:center;gap:8px 12px;margin-top:18px;padding:14px 12px!important;border-top:1px solid #e2e8f0;background:#f1f5f9!important;border-radius:0 0 14px 14px;min-height:auto!important;height:auto!important;position:static!important;box-shadow:none!important}',
      '#rag-overlay .rag-legal a{color:#0f2347!important;font-size:13px!important;font-weight:800!important;text-decoration:none!important;padding:10px 14px!important;border-radius:12px!important;background:#fff!important;border:1.5px solid #cbd5e1!important;display:inline-flex!important;align-items:center;line-height:1.2}',
