...
(function (global) {
  ...
  var BROWSE_I18N = {
    ar: {
      ...
      /* نطاقات افتراضية بالأوقية الجديدة (MRU) — تُستبدَل حسب القسم عبر RizqUx */
      'price-r1': 'أقل من 5,000',
      'price-r2': '5,000 — 25,000',
      'price-r3': '25,000 — 100,000',
      'price-r4': 'أكثر من 100,000',
      'save-ad': '♡ حفظ',
      'share-ad': '↗ مشاركة',
    ...
    fr: {
      ...
      'price-r1': 'Moins de 5 000',
      'price-r2': '5 000 — 25 000',
      'price-r3': '25 000 — 100 000',
      'price-r4': 'Plus de 100 000',
      'save-ad': '♡ Sauvegarder',
      'share-ad': '↗ Partager',
