...
(function (global) {
  ...
  var BROWSE_I18N = {
    ar: {
      ...
      'price-max': 'الأقصى',
      'nav-cats': 'الأقسام',
      'nav-assistant': '💎 المساعد (الماس)',
      'hero-ai-diamond': '💎 المساعد الذكي (الماس)',
      'nav-more': 'المزيد ▾',
      'dd-stores': 'المحلات',
      'dd-offices': 'المكاتب',
      'dd-rizqads': 'Rizq ADS',
    ...
    fr: {
      ...
      'price-max': 'Max',
      'nav-cats': 'Catégories',
      'nav-assistant': '💎 Assistant (Diamant)',
      'hero-ai-diamond': '💎 Assistant IA (Diamant)',
      'nav-more': 'Plus ▾',
      'dd-stores': 'Boutiques',
      'dd-offices': 'Bureaux',
      'dd-rizqads': 'Rizq ADS',
